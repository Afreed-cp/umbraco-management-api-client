 ...
 */
export function instanceOfMemberTypePropertyTypeResponseModel(value: object): value is MemberTypePropertyTypeResponseModel {
...
export function MemberTypePropertyTypeResponseModelFromJSON(json: any): MemberTypePropertyTypeResponseModel {
    return MemberTypePropertyTypeResponseModelFromJSONTyped(json, false);
}

export function MemberTypePropertyTypeResponseModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): MemberTypePropertyTypeResponseModel {
    if (json == null) {
        return json;
    }
    return {
...
export function MemberTypePropertyTypeResponseModelToJSON(json: any): MemberTypePropertyTypeResponseModel {
    return MemberTypePropertyTypeResponseModelToJSONTyped(json, false);
}

export function MemberTypePropertyTypeResponseModelToJSONTyped(value?: MemberTypePropertyTypeResponseModel | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
